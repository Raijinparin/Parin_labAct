...
<form method="post">
  ...
  <input type="text" name="service_name" value="<?php echo htmlspecialchars($service['service_name']); ?>"><br><br>
 
  <label>Description</label><br>
  <textarea name="description" rows="4" cols="40"><?php echo htmlspecialchars($service['description']); ?></textarea><br><br>
 
  <label>Hourly Rate</label><br>
  <input type="text" name="hourly_rate" value="<?php echo htmlspecialchars($service['hourly_rate']); ?>"><br><br>
